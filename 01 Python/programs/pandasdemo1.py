...
print(df.mean(numeric_only=True,axis=0))  #to calculate columnwise mean
print(df.mean(numeric_only=True,axis=1))  #to calculate rowwise mean
print(df.std(numeric_only=True))
print(df.median(numeric_only=True))
print(df.max(numeric_only=True))
print(df.describe(include='all')) #all statistical measures for all integer columns
